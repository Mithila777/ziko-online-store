...
function HeroSection({ title, highlight, description, image,  }:HeroProps) {
    ...
    <section className=" px-2 md:px-[6%] py-2 md:py-16 m-0">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-2 md:gap-10">
       ...
       <div className=" text-center md:text-left w-full lg:w-1/2">
         <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-200 leading-snug sm:leading-tight mb-2 md:mb-3 ">
    {title}{" "}
  ...
  <p className="text-gray-200 text-sm sm:text-base md:text-lg lg:text-xl mb-2 md:mb-4">
    {description}
  </p>

  <p className="text-xs sm:text-sm md:text-base font-medium text-gray-00 mb-2 md:mb-6">
